				...
				>
					<motion.div key={getPageTransitionKey()} {...PAGE_TRANSITION}>
						<Routes location={location}>
							...
							{/* BO2 Routes */}
							<Route
								path={ROUTES.games.bo2.base}
								element={<MapSelection gameId="bo2" />}
							/>
							<Route
								path={ROUTE_PATTERNS.games.bo2.maps.dieRise}
								element={<DieRise />}
							/>
							...
							/>
							<Route
								path={ROUTE_PATTERNS.games.bo3.maps.derEisendrache}
								element={<DerEisendrache />}
							/>
							<Route
