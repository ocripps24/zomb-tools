	...
	return (
		<BaseSection
			config={{
				...
				title: "Egg Symbols",
				description:
					"Select the 3 symbols found in the Footlight, Canals and Waterfront Districts",
				tipsConfig: {
					show: true,
					items: [
						{
							...
							nested: [
								{
									label: "Footlight → Canals ",
									text: "Look LEFT for Footlight symbol then RIGHT for Canals symbol",
								},
								{
									label: "Canals → Waterfront",
									text: "Look LEFT for both symbols",
								},
								{
									label: "Waterfront → Footlight",
									text: "Look RIGHT for both symbols",
								},
							],
						},
					],
						...
						<div className="egg-symbols__grid">
							{SYMBOLS.map((symbol) => {
								...
								return (
									...
									>
										<div className="egg-symbols__symbol-number">
											{symbol.id}
										</div>
